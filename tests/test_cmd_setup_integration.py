...
def test_setup_command_success(temp_home, gitspaces_config, monkeypatch, mock_console_input, mock_console_confirm, capsys):
...
def test_run_setup_creates_directories(temp_home, monkeypatch, mock_console_input, mock_console_confirm):
...
def test_run_setup_requires_at_least_one_path(temp_home, gitspaces_config, monkeypatch, mock_console_input, mock_console_confirm):
